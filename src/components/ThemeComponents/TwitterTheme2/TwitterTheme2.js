    ...
    >
      ...
      <div className="row">
        ...
        <div className="col-lg-10 col-md-10 col-sm-10">
          ...
          <font className="small pt-0 mt-0" style={{ color: "#DFDFDE" }}>
            {formData.username}
          </font>
        </div>
      </div>
      ...
      <div className="row  mx-1 mb-2 pb-1 border-bottom border-light">
        <small className="p-1">
          {formData.time} •{" "}
      ...
      <div className="row mt-2  mx-1 mb-2 pb-2 border-bottom border-light">
        <div className="col">
          <small>
